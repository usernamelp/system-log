...
/**
 * All rights reserved,Designed by tkylin
 *
 * @Description TODO
 * @Author tkylin@163.com
...
public class AESUtil {
    ...
    private static byte[] encryptOrDecrypt(int mode, byte[] contentBytes, String key, String iv,
            String modeAndPadding) throws InvalidKeyException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, NoSuchPaddingException, BadPaddingException, IllegalBlockSizeException, UnsupportedEncodingException {
    ...
    public static void main(String[] args) {
        ...
        String content = "{\"name\":\"测试服务器\",\"driver\":\"com.mysql.jdbc.Driver\",\"url\":\"jdbc:mysql://192.168.31.202:3406/autodialer?useUnicode\\u003dtrue\\u0026rewriteBatchedStatements\\u003dtrue\",\"username\":\"yclouduser\",\"password\":\"wMhdyelhMcljkq5M\"}";//ce214b206f650f32
